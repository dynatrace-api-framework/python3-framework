...
class TestModifyProblems(unittest.TestCase):
    ...
    def test_close_problem(self):
        ...
        result = problems.close_problem(CLUSTER, TENANT, PROBLEM_ID)
    ...
    def test_update_comment(self):
        ...
        result = problems.update_comment(CLUSTER, TENANT, PROBLEM_ID, COMMENT_ID)
    ...
    def test_delete_comment(self):
        ...
        result = problems.delete_comment(CLUSTER, TENANT, PROBLEM_ID, COMMENT_ID)
